 ...
 */
package com.app.mylib.navigation;
...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            centreButtonIcon = typedArray.getResourceId(R.styleable.SpaceNavigationView_centre_button_icon, R.mipmap.border_flip_icon);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (centreButtonIcon == NOT_DEFINED)
            centreButtonIcon = R.mipmap.border_flip_icon;
        ...
        if (centreButtonRippleColor == NOT_DEFINED)
            centreButtonRippleColor = ContextCompat.getColor(context, R.color.ripple_color);
