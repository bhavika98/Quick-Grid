...
public class StickerView extends FrameLayout {
    ...
    private enum ActionMode {
        ...
        CLICK    //Click the StickerData
    }

    Canvas canvas;

    private static final String TAG = "StickerView";
    public boolean stickerSelected = false;
    ...
    private BitmapStickerIcon topIcon;
    ...
    public StickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        borderPaint.setColor(getResources().getColor(R.color.Sticker_Border_Color));
        ...
        deleteIcon = new BitmapStickerIcon(
                ContextCompat.getDrawable(getContext(), R.mipmap.border_cancel_icon));
        zoomIcon = new BitmapStickerIcon(
                ContextCompat.getDrawable(getContext(), R.mipmap.border_move_icon));
        flipIcon = new BitmapStickerIcon(
                ContextCompat.getDrawable(getContext(), R.mipmap.border_flip_icon));
    }
    ...
    private void drawStickers(Canvas canvas) {
        ...
        if (handlingSticker != null && !locked) {
            ...
            //draw delete icon
            configIconMatrix(deleteIcon, x2, y2, rotation);
            ...
            //draw flip icon
            configIconMatrix(flipIcon, x3, y3, rotation);
    ...
    public boolean isInStickerArea(Sticker sticker, float downX, float downY) {
        stickerSelected = sticker.contains(downX, downY);
        isStickerTouch = stickerSelected;
    ...
    /**
     * StickerData's drawable will be too bigger or smaller
